...
$query = $db->prepare("
	SELECT online_id, online_id, online_user, online_status, online_time, Idutilisateur, Login
	FROM chat_online 
	LEFT JOIN utilisateurs ON utilisateurs.Idutilisateur = chat_online.online_user 
	ORDER BY Login
");
$query->execute();
